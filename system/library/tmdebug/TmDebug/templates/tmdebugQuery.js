 ...
 * tmdebugQuery
 *
 * This file is part of the Tomato Debug.
...
(function(){
	...
	var Query = TmDebug.Query = function(selector) {
	...
	Query.prototype.bind = function(event, handler) {
		...
		return this.each(function() {
			var elem = this, // fixes 'this' in iE
				data = elem.tmdebug ? elem.tmdebug : elem.tmdebug = {},
	...
	Query.prototype.data = function() {
		if (this[0]) {
			return this[0].tmdebug ? this[0].tmdebug : this[0].tmdebug = {};
		}
	};
	...
	Query.prototype.position = function(coords) {
		if (coords) {
			return this.each(function() {
				if (this.tmdebug && this.tmdebug.onmove) {
					this.tmdebug.onmove.call(this, coords);
				}
